...
$html = '<p>Why not <a href="mailto:test@test.com?subject=Hello" tile="Email me">email me</a>.
 Your email will be sent to test@test.com. Here is another mailto,
  with an email address as the anchor text: 
